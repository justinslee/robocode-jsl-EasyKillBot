...
public class TestEasyKillBotFiring extends RobotTestBed {
  ...
  // True if EasyKillBot has fired a bullet with power less than 1.4;
  boolean firePowerReachLevelOne = false;
  // True if EasyKillBot has fired a bullet with power between 1.5 to 1.9;
  boolean firePowerReachLevelTwo = false;
  // True if EasyKillBot has fired a bullet with power between 2.0 to 2.4;
  boolean firePowerReachLevelThree = false;
  // True if EasyKillBot has fired a bullet with power greater than 2.4;
   ...
   * that EasyKillBot is using proportional firing based on distance of detected enemy robot. 
   * 
  ...
  /**
   * After running all matches, determine if EasyKillBot has had variability in its bullet power.
   * 
