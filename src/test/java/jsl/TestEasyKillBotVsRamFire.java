 ...
 * This test simply verifies that EasyKillBot always beats RamFire.
 * 
 ...
 */
public class TestEasyKillBotVsRamFire extends RobotTestBed {

  /**
   * Specifies that RamFire and EasyKillBot are to be matched up in this test case.
   * @return The comma-delimited list of robots in this match.
   */
  @Override
  public String getRobotNames() {
    return "sample.RamFire,jsl.EasyKillBot";
  }
  ...
  /**
   * The actual test, which asserts that EasyKillBot has won every round against RamFire.
